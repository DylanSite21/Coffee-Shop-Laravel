...
{{-- ================================================================
     HERO SECTION
     ================================================================ --}}
<section class="hero-section py-5 fade-in">
    <div class="row align-items-center g-5" style="min-height:82vh;">
        <div class="col-lg-6 order-2 order-lg-1">
            ...
            <div class="d-flex gap-4 pt-3 fade-in-up delay-4" style="border-top:1px solid #DEC9AA;">
                <div>
                    <div style="font-family:'Playfair Display',serif;font-size:1.75rem;font-weight:800;color:#3E1F0D;">50+</div>
                    <div style="font-size:0.8rem;color:#6B4C3B;font-weight:500;">Varian Menu</div>
                </div>
                <div style="width:1px;background:#DEC9AA;"></div>
                <div>
                    <div style="font-family:'Playfair Display',serif;font-size:1.75rem;font-weight:800;color:#3E1F0D;">1.2K+</div>
                    <div style="font-size:0.8rem;color:#6B4C3B;font-weight:500;">Pelanggan Puas</div>
                </div>
                <div style="width:1px;background:#DEC9AA;"></div>
                <div>
                    <div style="font-family:'Playfair Display',serif;font-size:1.75rem;font-weight:800;color:#3E1F0D;">⭐ 4.9</div>
        ...
        <div class="col-lg-6 order-1 order-lg-2 text-center fade-in delay-1">
            <div class="hero-image-wrap mx-auto" style="max-width:520px;position:relative;">
                <img src="{{ asset('images/hero-bg.jpg') }}"
                     alt="Kopi Nusantara — Suasana Kedai"
                     class="img-fluid w-100"
                     style="height:460px;object-fit:cover;border-radius:1.5rem;">
                ...
                <div class="hero-stat-pill pill-bottom-left d-none d-lg-block">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <div style="font-size:0.7rem;color:#6B4C3B;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Terseduh Hari Ini</div>
                            <div style="font-size:1.1rem;font-weight:800;color:#3E1F0D;font-family:'Playfair Display',serif;">247 Cangkir</div>
                        </div>
                    </div>
                </div>
                <div class="hero-stat-pill pill-top-right d-none d-lg-block">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <div style="font-size:0.7rem;color:#6B4C3B;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Biji Kopi Lokal</div>
                    ...
                    <div class="card menu-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <div>
                                    <span class="badge mb-2" style="background:rgba(192,139,92,0.15);color:#6B3A2A;border:1px solid rgba(192,139,92,0.3);">
                            ...
                            <div class="mt-auto pt-2">
                                @auth
                                    ...
                                    @else
                                        <a href="{{ route('user.menus.show', $menu) }}" class="btn btn-outline-coffee w-100">
                                            Lihat Detail
                                        </a>
                                    @endif
                                @else
    ...
    <div class="row align-items-center g-5">
        <div class="col-lg-6">
            <div style="border-radius:1.25rem;overflow:hidden;box-shadow:0 8px 40px rgba(62,31,13,0.18);">
                <img src="{{ asset('images/about-coffee.jpg') }}"
                     alt="Biji Kopi Pilihan Kopi Nusantara"
                     class="img-fluid w-100"
                     style="height:380px;object-fit:cover;">
            </div>
        </div>
        <div class="col-lg-6 mt-4 mt-lg-0">
            <span style="font-size:0.8rem;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#C08B5C;">
                Tentang Kami
            </span>
            <h2 class="section-title text-start mt-2 mb-0" style="padding-bottom:0.5rem;">
                Cerita di Balik<br>Setiap Cangkir
            </h2>
            <div style="width:50px;height:3px;background:linear-gradient(90deg,#C08B5C,#D4A855);border-radius:99px;margin:0.75rem 0 1.25rem;"></div>
...
<section class="features-section py-5 mb-2">
    ...
    <div class="row g-4">
        @php
            $features = [
                ['icon'=>'🌱','title'=>'Biji Pilihan Petani Lokal',  'desc'=>'Kami berkolaborasi langsung dengan petani kopi dari Aceh, Toraja, Flores, dan daerah lainnya untuk mendapatkan biji terbaik setiap musim panen.'],
                ['icon'=>'👨‍🍳','title'=>'Barista Profesional',         'desc'=>'Tim barista kami bersertifikat internasional dengan pengalaman bertahun-tahun. Setiap cangkir dibuat dengan teknik dan perhatian penuh.'],
                ['icon'=>'⚡','title'=>'Pesanan Cepat & Mudah',       'desc'=>'Pesan melalui platform kami, bayar dengan mudah, dan nikmati pesananmu. Proses pembuatan dimonitor secara real-time.'],
                ['icon'=>'🏆','title'=>'Kualitas Terjamin',           'desc'=>'Seluruh menu melewati proses quality control yang ketat. Kepuasan Anda adalah prioritas utama kami sejak hari pertama.'],
                ['icon'=>'🌙','title'=>'Suasana Nyaman',              'desc'=>'Desain interior hangat dengan pencahayaan yang nyaman, cocok untuk bekerja, bertemu teman, atau sekadar menikmati waktu sendiri.'],
                ['icon'=>'💝','title'=>'Program Loyalitas',           'desc'=>'Dapatkan poin setiap pembelian dan tukarkan dengan minuman gratis, diskon spesial, dan berbagai hadiah menarik lainnya.'],
            ];
        @endphp
        @foreach($features as $i => $feat)
            <div class="col-md-6 col-lg-4 fade-in-up delay-{{ $i % 4 + 1 }}">
                <div class="card h-100" style="border:1px solid #EDD9BC;background:linear-gradient(135deg,#FDF6ED 0%,#F5E8D4 100%);">
                    <div class="card-body p-4">
                        <div style="font-size:2.25rem;margin-bottom:0.875rem;">{{ $feat['icon'] }}</div>
                        <h5 class="card-title mb-2">{{ $feat['title'] }}</h5>
                        <p class="card-text" style="font-size:0.875rem;color:#6B4C3B;line-height:1.7;">{{ $feat['desc'] }}</p>
                    </div>
                </div>
            </div>
        @endforeach
...
<section class="testimonials-section py-5 mb-2"
    ...
    <div class="row g-4">
        @php
            $testimonials = [
                ['name'=>'Rania Kusuma',   'role'=>'Mahasiswi UI',       'rating'=>5, 'text'=>'Cappuccino di sini beneran beda! Foam-nya lembut, rasanya pas banget antara pahit dan manisnya. Jadi langganan rutin sebelum kuliah.', 'avatar'=>'R'],
                ['name'=>'Budi Santoso',   'role'=>'Software Engineer',  'rating'=>5, 'text'=>'Tempatnya cozy banget buat kerja. WiFi kencang, kopi enak, dan staff-nya ramah. Caramel Macchiato-nya jadi andalan saya setiap hari!', 'avatar'=>'B'],
                ['name'=>'Dira Anggraini', 'role'=>'Content Creator',    'rating'=>5, 'text'=>'Matcha Latte di sini mengalahkan banyak coffee shop lain yang pernah saya coba. Worth it banget! Pasti balik lagi bawa teman-teman.', 'avatar'=>'D'],
            ];
        @endphp
        @foreach($testimonials as $testi)
            <div class="col-md-4">
                <div style="background:rgba(253,246,237,0.08);border:1px solid rgba(255,255,255,0.1);border-radius:1rem;padding:1.75rem;height:100%;backdrop-filter:blur(10px);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div style="width:46px;height:46px;border-radius:50%;background:linear-gradient(135deg,#C08B5C,#D4A855);display:flex;align-items:center;justify-content:center;font-size:1.1rem;font-weight:800;color:#3E1F0D;flex-shrink:0;">
                            {{ $testi['avatar'] }}
                        </div>
                        <div>
...
<section class="cta-section py-5 text-center">
    <div style="max-width:560px;margin:auto;">
        ...
        <h2 style="font-family:'Playfair Display',serif;font-size:2rem;font-weight:800;color:#3E1F0D;margin-bottom:0.75rem;">
            Siap Memesan?
        </h2>
